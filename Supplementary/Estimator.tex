...
When applied to real world cases, the variance can be estimated by sample variance $S$ of the kernel embedded PDR estimator, 
...
By Slutsky's lemma, we can perform a hypothesis test on whether the true ATE is 0 using $S$. 
The hypothesis is $H_0: \chi_0=0\leftrightarrow H_1: \chi_0\neq 0$. 
Let $Z_{\frac{\alpha}{2}}$ be the upper $\frac{\alpha}{2}$ percentile of normal distribution. 
The corresponding statistic and confidence interval with significance level $\alpha$ are
\begin{equation*}
    Z:= \frac{\widehat{\chi}}{\sqrt{\frac{S}{n_c}}},\ [\widehat{\chi}-\sqrt{\frac{S}{n_c}}Z_{\frac{\alpha}{2}}, \widehat{\chi}+\sqrt{\frac{S}{n_c}}Z_{\frac{\alpha}{2}}]. 
\end{equation*}
...
\begin{align*}
    ...
    l((Z,A,X),(Z',A',X')) &:= \mathbb{1}_{A=a}\mathbb{1}_{A'=a}\exp\{-\gamma\|[Z X]-[Z' X']\|^2\},\ \forall a\in\{0,1\}, 
\end{align*}
...
By sample deviation $S=0.5352$, the Z-statistic $\frac{\widehat{\chi}}{\sqrt{\frac{S}{n_c}}}=\frac{3.12}{\sqrt{\frac{0.5352}{1000}}}$ is 411.6110, 
which locates at the extremely far right tail of the standard normal distribution. 
The p-value 
\begin{equation*}
    P_{Wald} = 2Pr(1-\Phi(411.6110)) \approx 0, 
\end{equation*}
